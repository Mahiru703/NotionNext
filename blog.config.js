...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Mahiru', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '学生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://mahiru703.top', // 网站地址
